...
/**
 * This is the model class for table "users_connections".
 *
 * The followings are the available columns in table 'users_connections':
 * @property integer $user_id
 * @property string $hybridauth_session
 * @property string $updated_at
 */
class UsersConnections extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return UsersConnections the static model class
	 */
